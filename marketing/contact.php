          ...
          <div class="col-lg-6 py-3">
            ...
            <ul class="contact-list">
              <li>
                ...
                <div class="content">123 Street,Lebanon, Asia</div>
              </li>
              <li>
                <div class="icon"><span class="mai-mail"></span></div>
                <div class="content"><a href="#">hamdan54hh@gmail.com</a></div>
              </li>
              <li>
    ...
    <div class="container">
      <div class="row justify-content-center mb-5">
        <div class="col-lg-3 py-3">
          ...
          <p><a href="#" >hamdan54hh@gmail.com</a></p>
          <p><a href="#">+961 78896221</a></p>
        </div>
        <div class="col-lg-3 py-3">
          <h5>Quick Links</h5>
